    ...
    <form action="ac.php" method="post">
        ...
        <div class="form-group">
			<div class="input-group">
				...
				<i class="fa fa-twitter-square"></i> &nbsp &nbsp
				<i class="fa fa-facebook-square"></i>&nbsp &nbsp
				<i class="fa fa-linkedin-square"></i>&nbsp &nbsp
				<i class="fa fa-youtube-square"></i>&nbsp &nbsp
