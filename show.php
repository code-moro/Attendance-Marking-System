...
<div class="signup-form">
    <form action="attend.php" method="post">
		...
		<hr>
         ...
         <select name="divisions" style="width:290px;height:40px;" required  >
         <option value="Select Division" name="div" selected>Select Division</option>
    ...
    <option value="SE B">SE B</option>
         ...
         <div class="form-group">
			<div class="input-group">
				<span class="input-group-addon"><i class="fa fa-home"></i></span>
         <select name="subject" style="width:290px;height:40px;" required>
    ...
    <option value="dm">discrete maths</option>
     ...
     <div class="form-group">
         ...
         <input type=text name='absent'  placeholder="Enter Absent no" style="width:290px;height:40px;" >
  </div>
     </div>  
	 <div class="form-group">
			<div class="input-group">
				<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
         <input type=date value=date placeholder="Date"  name='dat'style="width:290px;height:40px;" required>
  </div>
     </div>  
		<div class="form-group">
            <button type="submit" class="btn btn-primary btn-lg">Take Attendence</button>
